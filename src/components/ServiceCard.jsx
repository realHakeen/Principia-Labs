        ...
        <div className="flex justify-between items-start mb-6">
          ...
          {status === "active" && (
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-mono text-green-500 uppercase tracking-widest hidden group-hover:block group-hover:text-black transition-all">Online</span>
